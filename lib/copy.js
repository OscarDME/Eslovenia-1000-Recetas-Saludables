...
export const copy = {
  ...
  story: {
    ...
    problems: [
      ...
      },
      {
        ...
        desc: "Nekatere sestavine lahko povzročijo intoleranciju, zaprtje, pline in nelagodje.",
      },
    ],
    ...
    items: [
      {
        icon: "Utensils",
        title: "Okusni in zdravi recepti",
        desc: "Ogromno raznolikih, uravnoteženih in hranljivih receptov – od kosil in večerij do zdravih domačih omak in krem.",
      },
      {
        icon: "BookOpen",
  ...
  finalCta: {
    ...
    headline:
      "VZEMI NAŠO DIGITALNO KNJIGO DANES Z OGROMNIM POPUSTOM!",
    subUrgency:
    ...
    urgencyText: "PLAČILO JE 100% VARNO",
  ...
  faq: {
    authorRole: "Chef Ana Novak in Ekipa za zdravo prehrano",
