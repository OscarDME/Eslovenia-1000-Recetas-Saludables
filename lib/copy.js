...
export const copy = {
  metadata: {
    title: "Esencia Pro | 1000 Zdravih receptov 2.0",
    description:
  ...
  brand: {
    name: "Esencia Pro",
    tagline: "1000 Zdravih receptov 2.0",
  },
    ...
    items: [
      {
        ...
        tag: "BONUS 1",
        title: "E-knjiga: 15 Zdravih juh",
        desc: "Vsebuje 15 receptov za tople juhe z nizko vsebnostjo ogljikovih hidratov in sladkorjev.",
        value: "15 €",
      },
      {
        image: "/bonuses/batidos.webp",
        tag: "BONUS 2",
        title: "E-knjiga: 10 Zdravih smutijev",
        desc: "10 receptov za osvežilne smutije z malo ogljikovimi hidrati in sladkorji.",
        value: "15 €",
      },
      {
        image: "/bonuses/snacks.webp",
        tag: "BONUS 3",
        title: "E-knjiga: 15 Zdravih prigrizkov",
        desc: "15 idej za hitre in zdrave vmesne obroke za ljudi s sladkorno boleznijo.",
        value: "15 €",
      },
      {
  ...
  finalCta: {
    ...
    bundleList: [
      ...
      "Bonus 1 — 15 Zdravih juh",
      "Bonus 2 — 10 Zdravih smutijev",
      "Bonus 3 — 15 Zdravih prigrizkov",
  ...
  faq: {
    authorRole: "Esencia Pro · Ekipa za zdravo prehrano",
    authorHeadline: "Okusna hrana, ki skrbi za tvoje zdravje",
    authorBio:
      "Pri Esencia Pro verjamemo, da ti sladkorna bolezen ne sme vzeti užitka ob hrani. Vsak posamezen recept je bil ustvarjen z mislijo na to, da lahko uživaš brez slabe vesti in ohraniš glukozo pod popolnim nadzorom.",
    authorImageAlt: "Ekipa Esencia Pro",
